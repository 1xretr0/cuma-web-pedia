...
CREATE TABLE `cm_administradores`  (
  ...
  UNIQUE INDEX `fk_administradores_usuarios_id`(`id_usuario` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Usuarios de tipo administrador del sistema' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Catalogo de áreas geográficas que se emplean para etiquetar los recursos y uams del sistema.' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Catalogo de los estados migratorios definidos para etiquetar las uams del sistema' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Catálogo de grupos culturales para etiquetar recursos, hechos culturales y uams del sistema' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_idiomas_ctl`  (
  ...
  `nombre_idioma` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Nombre del idioma',
  `clave_idioma` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Clave abreviada del idioma',
  PRIMARY KEY (`id_idioma`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Catálogo de idiomas disponibles en el sistema.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_recursos`  (
  ...
  INDEX `fk_recursos_idiomas_id`(`id_idioma` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Recursos literarios, digitales, entre otros, (páginas web, libros, artículos, ensayos, anécdotas, escritos, reportes)  que forman parte del sistema y pueden estar etiquetados por grupo cultural, época, área geográfica, idioma. También pueden relacionarse con uno o más hechos culturales y/o sanitarios.' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Catalogo de los tipos de recurso existentes en el sistema' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Usuarios registrados con una cuenta personal en la página del sistema.' ROW_FORMAT = Dynamic;
